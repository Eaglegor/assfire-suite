...
#include "assfire/scheduler/engine/algorithms/LinearWaybillSchedulingAlgorithm.hpp"
...
TEST_F(LinearWaybillSchedulingAlgorithmTest, AllocationsAreScheduledWithLateIfTimeWindowsAreTooTight) {
    makeSimpleTest(R"(
