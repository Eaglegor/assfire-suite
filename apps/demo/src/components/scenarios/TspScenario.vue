...
export default {
  ...
  data() {
    return {
      routingSettings: RoutingSettings.RoutingSettingsModel.createDefault().withRouterEngine(RoutingSettings.ROUTER_ENGINE_TYPE_CROWFLIGHT),
