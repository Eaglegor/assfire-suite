...
namespace assfire::sample {
    ...
    void MetricsCollector::incrementGreetsStartingFromA()
    {
        if (!exposer) return;
    ...
    void MetricsCollector::incrementGreetsStartingFromB()
    {
        if (!exposer) return;
    ...
    void MetricsCollector::incrementGreetsStartingFromNotAB()
    {
        if (!exposer) return;
    ...
    assfire::metrics::stopwatch MetricsCollector::greetingStopwatch()
    {
