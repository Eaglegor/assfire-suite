function(define_helm_target)
    ...
    add_custom_target(${TARGET_NAME}-upload
            DEPENDS ${TARGET_NAME}
            COMMAND ${CURL_EXECUTABLE} --request POST --user $CI_REGISTRY_USER:$CI_REGISTRY_PASSWORD --form "chart=@${CHART_NAME}-${CHART_VERSION}.tgz" "$ENV{CI_API_V4_URL}/projects/$ENV{CI_PROJECT_ID}/packages/helm/api/stable/charts"
            WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/${CHART_ROOT}
