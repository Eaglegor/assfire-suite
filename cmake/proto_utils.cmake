...
function(define_proto_go_target)
    set(_options "")
    set(_singleargs TARGET_NAME)
    set(_multiargs DEPENDS PROTO_IMPORT_DIRS PROTOS GO_MOD_PATH PROTO_ROOT GO_PACKAGE_NAME)
    ...
    set(GO_MOD_PATH ${CMAKE_CURRENT_BINARY_DIR})
    ...
    file(MAKE_DIRECTORY ${GO_MOD_PATH}/${GO_PACKAGE_NAME})

    add_custom_command(
            OUTPUT ${GO_MOD_PATH}/${GO_PACKAGE_NAME}/go.mod
            COMMAND ${GO_EXECUTABLE} mod init ${GO_PACKAGE_NAME}
            WORKING_DIRECTORY ${GO_MOD_PATH}/${GO_PACKAGE_NAME}
            COMMENT "[Protobuf][Go] Generating ${GO_MOD_PATH}/${GO_PACKAGE_NAME}/go.mod for ${TARGET_NAME}"
            VERBATIM
    )
    ...
    add_custom_command(
            ...
            ${PROTOS}
            DEPENDS ${FULL_PROTOS} ${GO_MOD_PATH}/${GO_PACKAGE_NAME}/go.mod
    ...
    add_custom_command(
            OUTPUT ${GO_MOD_PATH}/${GO_PACKAGE_NAME}/go.sum
            COMMAND ${GO_EXECUTABLE} mod tidy
            WORKING_DIRECTORY ${GO_MOD_PATH}/${GO_PACKAGE_NAME}
            DEPENDS ${GO_MOD_PATH}/${GO_PACKAGE_NAME}/go.mod ${GO_SOURCE_OUTPUTS}
    ...
    add_custom_target(${TARGET_NAME} ALL
            ...
            WORKING_DIRECTORY ${GO_MOD_PATH}/${GO_PACKAGE_NAME}
            DEPENDS ${GO_SOURCE_OUTPUTS} ${GO_MOD_PATH}/${GO_PACKAGE_NAME}/go.sum)
