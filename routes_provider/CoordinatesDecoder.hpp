...
namespace assfire
{
	...
	public:
		...
		static double decode(std::int32_t coordinate, const routing::proto::CoordinateFormat& format) noexcept
		{
	...
	private:
		static double convertFixedPointIntRepresentation(std::int32_t coordinate, const routing::proto::CoordinateFormat::FixedPointInt& format) noexcept
		{
		...
		{
			routing::proto::CoordinateFormat::FixedPointInt default_format;
